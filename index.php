        ...
        if(empty($_POST['mdp'])){
            ...
            if(!$mysqli){
                ...
                if(mysqli_num_rows($Requete) == 0) {
                    ...
                    header('Location: http://192.168.1.65/new-page');
									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group">
												...
												<input name="pseudo" type="email" class="form-style" placeholder="Email">
												<i class="input-icon uil uil-at"></i>
											</div>	
											<div class="form-group mt-2">
												<input name="mdp" type="password" class="form-style" placeholder="Password">
                                                <button type="submit" name="connexion" value="Connexion" class="btn mt-4">Login</button>
                                               </form>
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											
                      <p class="mb-0 mt-4 text-center"><a href="forget-page.html" class="link">Forgot your password?</a></p>
				      					</div>
			      					</div>
			      				</div>
								<div class="card-back">
